...
| **AI Coding Agent**   | [pi](https://pi.dev) (managed install) with [pi-stuff](https://github.com/meteyou/pi-stuff)       |
...
└── run_onchange_after_install-pi.sh.tmpl      # Node.js (asdf), pi
```
...
5. Install Node.js via asdf, [pi](https://pi.dev)
